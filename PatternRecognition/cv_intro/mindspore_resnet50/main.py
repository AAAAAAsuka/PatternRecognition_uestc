...
parser.add_argument('--checkpoint_path', type=str, default='./model/train_resnet_cifar10-10_1875.ckpt',
                    help='CheckPoint file path.')
parser.add_argument('--dataset_path', type=str, default='X:/cifar100/cifar-10-batches-bin', help='Dataset path.')
